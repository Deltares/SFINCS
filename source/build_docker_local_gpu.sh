...
docker build -f Dockerfile.gpu.25.5.ccall . -t mvanormondt/sfincs-gpu:coldeze_combo_ccall_255_xxx > build.log 2>&1
docker push mvanormondt/sfincs-gpu:coldeze_combo_ccall_255_xxx
