...
!   real*4, dimension(nobs) :: zobs, hobs
   ...
   ! add user input params for reproducability
        ...
        NF90(nf90_put_att(ncid, varid, 'nfreqsig', wavemaker_nfreqs_ig))  
        NF90(nf90_put_att(ncid, varid, 'freqminig',wavemaker_freqmin_ig))  
        NF90(nf90_put_att(ncid, varid, 'freqmaxig',wavemaker_freqmax_ig))  
        ...
        NF90(nf90_put_att(ncid, varid, 'wmtfilter', wavemaker_filter_time))         
        NF90(nf90_put_att(ncid, varid, 'wmfred',wavemaker_filter_fred))         
        ...
        NF90(nf90_put_att(ncid, varid, 'wfpfile',wavemaker_wfpfile))   
        NF90(nf90_put_att(ncid, varid, 'whifile',wavemaker_whifile))   
        NF90(nf90_put_att(ncid, varid, 'wtifile',wavemaker_wtifile))   
        NF90(nf90_put_att(ncid, varid, 'wstfile',wavemaker_wstfile))   
        ...
        NF90(nf90_put_att(ncid, varid, 'wvmfile',wavemaker_wvmfile)) 
        !
        ! Netcdf input
