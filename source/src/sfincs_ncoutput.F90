...
module sfincs_ncoutput
   ...
   type his_type
      ...
      integer :: drain_varid, drain_name_varid, drain_fraction_open_varid
...
!   NF90(nf90_put_var(map_file%ncid, map_file%face_y_varid, yz(2:nmax+1-1, 2:mmax+1-1), (/1, 1/))) ! write yz of edges   
   ...
   use sfincs_snapwave
   use sfincs_src_structures, only: nr_src_structures, src_struc_q_now, src_struc_fraction_open
