...
contains
   ...
   type(NormalFlow) :: results_t1,results_t2,results_t3,results_t4
   ...
   breach_bottom = (breach_bottom + 2 * (crit_water_depth / (crest_level - breach_level)) * stt * dt / ((1 - p) * adap_length_sediment * tan(gamma1)))
