...
contains
   ...
   call read_logical_input(500,'timestep_diagnostics',timestep_diagnostics,.false.)
   ...
   call read_logical_input(500,'snapwave_his_legacy_names',snapwave_his_legacy_names,.false.)
