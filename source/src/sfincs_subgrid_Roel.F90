...
contains
   ...
   enddo   
   !
   NF90(nf90_get_var(net_file_sbg%ncid, net_file_sbg%z_dep_varid, rtmpz2(2:subgrid_nbins,:)))
   !
   do ip = 1, np
   ...
   enddo   
   !
   NF90(nf90_get_var(net_file_sbg%ncid, net_file_sbg%uv_havg_varid, rtmpuv2(2:subgrid_nbins,:) ))
   !
   ...
   enddo
   !
   NF90(nf90_get_var(net_file_sbg%ncid, net_file_sbg%uv_nrep_varid, rtmpuv2(2:subgrid_nbins,:) ))
   !
   do ip = 1, npuv
      do ibin = 2, subgrid_nbins
         !
   ...
   !
   NF90(nf90_get_var(net_file_sbg%ncid, net_file_sbg%uv_pwet_varid, rtmpuv2(2:subgrid_nbins,:) ))
   !
   do ip = 1, npuv
      do ibin = 2, subgrid_nbins
